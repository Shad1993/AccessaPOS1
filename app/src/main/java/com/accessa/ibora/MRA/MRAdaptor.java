...
public class MRAdaptor extends RecyclerView.Adapter<MRAdaptor.ViewHolder> {

    private Cursor mCursor;

    public MRAdaptor(Cursor cursor) {
        this.mCursor = cursor;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mra_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MRAdaptor.ViewHolder holder, int position) {
