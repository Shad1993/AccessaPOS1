...
public class CompletedSplittedTransactionsAdapter extends RecyclerView.Adapter<CompletedSplittedTransactionsAdapter.ItemViewHolder> {

    private Context mContext;
    private Cursor mCursor;
    private List<String> data;

    public CompletedSplittedTransactionsAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
    ...
    public void onBindViewHolder(@NonNull CompletedSplittedTransactionsAdapter.ItemViewHolder holder, int position) {
