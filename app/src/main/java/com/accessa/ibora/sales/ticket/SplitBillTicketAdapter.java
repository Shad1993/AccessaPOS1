...
public class SplitBillTicketAdapter extends RecyclerView.Adapter<SplitBillTicketAdapter.ItemViewHolder> {
    ...
    public SplitBillTicketAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.splitbillticket_item, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull SplitBillTicketAdapter.ItemViewHolder holder, int position) {
