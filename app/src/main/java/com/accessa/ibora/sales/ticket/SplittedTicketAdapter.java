...
public class SplittedTicketAdapter extends RecyclerView.Adapter<SplittedTicketAdapter.ItemViewHolder> {
    ...
    public SplittedTicketAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.splitted_ticket_item, parent, false);
        return new ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SplittedTicketAdapter.ItemViewHolder holder, int position) {

        Log.d("SplittedTicketAdapter", "onBindViewHolder called for position: " + position);

        // Check if the Cursor is null or if it has not been moved to the current position.
        if (mCursor == null || !mCursor.moveToPosition(position)) {
            Log.e("SplittedTicketAdapter", "Cursor is null or cannot move to position: " + position);
...
// Check if the data is correctly retrieved
        Log.d("SplittedTicketAdapter", "Data: id=" + id + ", uniques=" + uniques + ", description=" + description + ", price=" + price);
