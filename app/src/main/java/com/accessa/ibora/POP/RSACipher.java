...
public class RSACipher {
    ...
    public static PublicKey stringToPublicKey(String publicKeyString) {
        try {
            ...
            publicKeyString = publicKeyString.replaceAll("<RSAParameters.*?>", "")
                    .replaceAll("</RSAParameters>", "")
                    .replaceAll("<Exponent.*?>", "")
                    .replaceAll("</Exponent>", "")
                    .replaceAll("<Modulus.*?>", "")
                    .replaceAll("</Modulus>", "")
            ...
            // Decode the Base64-encoded Modulus value
            byte[] keyBytes = Base64.decode(publicKeyString, Base64.DEFAULT);

            // Create the RSA public key spec
            X509EncodedKeySpec keySpec = new X509EncodedKeySpec(keyBytes);

            // Generate the RSA public key from the spec
