...
public class PrintSave extends AppCompatActivity {
        ...
        protected void onConnected(SunmiPrinterService service) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(PrintSave.this));
                    Cursor cursor1 = mDatabaseHelper.getAllInProgressTransactionsByType(TransactionType,transactionIdInProgress);
                    adapter = new TicketAdapter(PrintSave.this, cursor1);
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(PrintSave.this, ReceiptActivity.class);
