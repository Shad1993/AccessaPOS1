...
public class CatBodyActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            // get body fragment
            CatBodyFragment fragment = (CatBodyFragment) getSupportFragmentManager().findFragmentById(R.id.bodyFragment);
