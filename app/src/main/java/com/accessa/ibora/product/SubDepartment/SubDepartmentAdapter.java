...
public class SubDepartmentAdapter extends RecyclerView.Adapter<SubDepartmentAdapter.ItemViewHolder> {

    private Context mContext;
    private Cursor mCursor;

    public SubDepartmentAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        String UserID = mCursor.getString(mCursor.getColumnIndex(DatabaseHelper.DEPARTMENT_CASHIER_ID));
